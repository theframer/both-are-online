  ...
  return (
    <>
      ...
      <div className="min-h-screen relative" style={{ zIndex: 1 }}>
        ...
        >
          {/* We're using a full width inner wrapper (no max-w) so the bar is truly full width */}
          <div className="nav-row">
            <div className="nav-left">
              {/* reserved for left side controls */}
            </div>

            <div className="nav-center" aria-hidden>
              <div className="logo">
                <span style={{ color: "var(--pink)", fontWeight: 700, fontSize: 18 }}>Both</span>
                <span style={{ color: "var(--fg)", fontWeight: 700, fontSize: 18, marginLeft: 6 }}>Are Online</span>
              </div>
            </div>
            ...
            <div className="nav-right">
              ...
              <button
                ...
                title="Toggle theme"
              >
                <span className="theme-heart" aria-hidden>{theme === "dark" ? "🌙" : "☀️"}</span>
              </button>
            </div>
          </div>
        </nav>
      ...
      {/* footer — single clean panel, aligned with other content */}
  ...
  <div className="footer-panel max-w-7xl mx-auto p-6 bg-[var(--panel)] border border-[var(--border)] rounded-2xl shadow-sm">
    <div className="footer-inner grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="left-footer text-left">
        <div className="text-xl font-bold" style={{ color: "var(--pink)", fontWeight: 700, fontSize: 18 }}>Both</div>
        <div className="text-xl font-bold mb-2" style={{ color: "var(--fg)", fontWeight: 700, fontSize: 18, marginLeft: 6 }}>Are Online</div>

        <div className="text-sm opacity-80 leading-relaxed" style={{fontSize: 10 }}>
      ...
      <div className="right-footer md:flex md:flex-col md:items-end md:justify-center text-left md:text-right">
        <div className="mt-2 text-sm opacity-80" >
          {" "}
          <a
            href="https://formspree.io/f/mldlrjdp"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block ml-1 px-3 py-1 rounded-full border border-[var(--border)] bg-[var(--panel)] text-[var(--accent)]"
          >
            Contact Us
          </a>
        </div>
        <div className="mt-4 text-xs opacity-70" style={{fontSize: 10 }}>Copyright © 2025 trudev. All rights reserved.</div>
      </div>
    </div>
  </div>
</footer>
