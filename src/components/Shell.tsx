  ...
  return (
    <>
      ...
      <div className="min-h-screen relative" style={{ zIndex: 1 }}>
          ...
          <div className="nav-row">
            ...
            <div className="nav-center" aria-hidden>
              <div className="logo" style={{ display: "flex", alignItems: "center", gap: 6 }}>
                ...
                <span style={{ color: "var(--fg)", fontWeight: 700, fontSize: 18 }}>Are Online</span>
              </div>
            </div>
        ...
        <footer className="site-footer w-full mt-8" role="contentinfo">
          <div className="footer-panel max-w-7xl mx-auto p-6 bg-[var(--panel)] border border-[var(--border)] rounded-2xl shadow-sm">
            <div className="footer-inner grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="left-footer text-left">
                ...
                <div className="text-xl font-bold mb-2" style={{ color: "var(--fg)", fontWeight: 700, fontSize: 18 }}>Are Online</div>
              ...
              <div className="right-footer md:flex md:flex-col md:items-end md:justify-center text-left md:text-right">
                ...
                <div className="mt-4 text-xs opacity-70" style={{ fontSize: 10 }}>
        ...
        {/* Contact modal (renders ContactForm.jsx when requested) */}
        {showContactModal && (
